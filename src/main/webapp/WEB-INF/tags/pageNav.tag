...
<ul class="pagination">
	...
	<c:if test="${pageObject.endPage < pageObject.totalPage }">
	  	<li data-page=${pageObject.endPage + 1 }>
	  		<a href="${listURI }?page=${pageObject.endPage + 1 }&prePageNum=${pageObject.prePageNum}&key=${pageObject.key}&word=${ pageObject.word}"
	...
	<c:if test="${pageObject.page < pageObject.totalPage }">
	  	<li data-page=${pageObject.totalPage }>
	  		<a href="${listURI }?page=${pageObject.totalPage }&prePageNum=${pageObject.prePageNum}&key=${pageObject.key}&word=${ pageObject.word}"
