...
<body>
	<div class="container">
		<div class="titleStyle">
			<h1>PW를 입력해주시기 바랍니다.</h1>
		</div>
		<form method="post" action="/user/userModifyPwCheck">
			<div class="form-group">
				<label for="id">PW</label> <input type="password" class="form-control"
					id="pw" name="pw" placeholder="pw" required>
